...
<boby>
	...
	<table cellspacing=1 width=600px border=1>
	<tr> 
		<td width=70px>번호</td>
	...
	<tr> 
		<td width=70px>제목</td>
		<td><input style="width:450px;" type="text" name="title" id="title"></td>
	</tr>
	<tr> 
		<td width=70px>일자</td>
		<td><%=day%></td>
	...
	<tr> 
		<td width=70px>내용</td>		
		<td height=300px>
		<textarea id="summernote" style="width:500px;height:200px;overflow-y:scroll;resize:none;"  type="text" name="content"></textarea></td>
	</tr>
	</table>	
	<table width=650px>
	<tr>
