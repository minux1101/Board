...
<boby>
	...
	<tr>
		...
		%>		
			<td width=100><p align=center><img src="upload\fileicon.jpg"></td>
		<%
		}
		%>
	...
	<tr>
	 ...
	 <table style="margin-left:300px">
         <tr>  <!-- << 에 1페이지를 연결해서 <<을 누르면 1페이지로 돌아감.-->
            <td style=text-align:center; width=20px;><a href="./board_list.jsp?pageNum=1">&lt;&lt;</a></td>
            <!-- < 에 연될될 페이지  -->
            <td style=text-align:center; width=20px;><a href="./board_list.jsp?pageNum=<%=nPage%>">&lt;</a></td>
    <%         
        for(int i = startPage; i <= endPage; i++){  /* i페이지에 연결될 url*/
    %>      <td style=text-align:center; width=20px;><a href="./board_list.jsp?pageNum=<%=i%>"><%= i %></a></td>
    <%
        }           
        if(endPage < pageCount){  /* > 에 연결될 페이지 */
    %>
            <td style=text-align:center; width=20px;><a href="./board_list.jsp?pageNum=<%=startPage+pageBlock%>">&gt;</a></td>
    <%		
        } else {
    %>
    		<td style=text-align:center; width=20px;><a href="./board_list.jsp?pageNum=<%=pageCount%>">&gt;</a></td>    		
    <%		
        } 
    %>
     ...
     <br>   
	<form style="margin-left:150px;" name="filter">
